                ...
                <InsertItemTemplate>
                    ...
                    <div class="cicoleft">
                        <asp:Table ID="ContactTable" runat="server" CssClass="datatable" Visible="true">
                            <asp:TableRow><asp:TableCell ColumnSpan="2" CssClass="headertable"><h2>Contact Information</h2></asp:TableCell></asp:TableRow><asp:TableRow><asp:TableHeaderCell><asp:Label ID="PhoneDLLabel" runat="server" Text="Phone/DL"></asp:Label></asp:TableHeaderCell><asp:TableCell>
                            ...
                            <asp:TableRow>
                                <asp:TableCell ColumnSpan="2" Width="100%">
                                    ...
                                    <asp:DetailsView ID="DetailsViewContactSelected" runat="server" 
                                        ...
                                        DataKeyNames="ContactID" DataSourceID="LinqDataSourceContacts" OnItemCommand="DetailsViewContactSelected_ItemCommand" 
